...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'Inventory', 'inventory@gmail.com', NULL, NULL, 'Rs.', 1);
...
(1, 'Bonsai', 'Shop for your favorite plant, gardening products, seeds and many more...', '1660022454bonsai-logo.png', 'A plant needs sunlight, carbon dioxide, minerals and water to make food by photosynthesis. A green substance in plants called chlorophyll traps the energy from the Sun needed to make food.', 'Copyright 2022', 'Rs.', '8618956911', 'nisarga@email1.com', '#123, India');
